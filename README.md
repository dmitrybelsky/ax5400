...
> **После получения SSH-доступа:** см. [AP_MANAGEMENT_RU.md](AP_MANAGEMENT_RU.md) —
> персистентное хранилище, dumb AP, 802.11r-роуминг, мониторинг клиентов и
> все возможности, открывающиеся через shell.
